...
/**
 * The command to return to the overview page.
 */
public class HomeCommand {

	/**
	 * Registers the "home" command on the given dispatcher
	 *
	 * @param dispatcher the dispatcher
	 * @param cli the cli
	 */
	public static void register(CommandDispatcher dispatcher, Cli cli) {
		dispatcher.register(Command.create("home")
				.executes(_ -> cli.navigateToOverview()));
	}
